...
**bold** What am I interested in asking for the course project??? **bold**
```
print("How does heritage affect the microbiome composition? How does ruminococcus gnavus affect the composition of the microbiome? How does diet or heritage affect ruminococcus gnavus?")
```
...
getwd()
setwd("/Users/joshuays/UMich_Bio201_F19/Lab2") 
```
