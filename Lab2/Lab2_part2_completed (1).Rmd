...
#There is a set hierarchy of what classes are preferential over others. Numeric is over logical, and character is over both
```
...
#It will be a character vector for the previously stated reasons. Character will be preffered over numerical.
```
...
study_semesters <- c("Winter_2015", "Fall_2015", "Winter_2016", "Fall_2016", "Winter_2017", "Fall_2017", "Winter_2018","Fall_2018", "Winter_2019", "Fall_2019")
# Build a vector where the supplements consumed matches the order of the study semesters: 
supplements <- ("RPS", "RMS", "RPS", "Inulin", "Arabinoxylan", "Psyllium", "RPS", "RPS", "RMS", "Inulin", "Accessible", "RPS", "HiMaize", "Banana", "HiMaize", "RPS", "RMS", "RPS", "RPS", "Oats", "Rice", "Potatos")
# What type are each of these?  Both are character type
```
...
mean(digits=2, pH_1) == mean(digits=2, pH_2)
