...
```
  ...
  Neither of the propionate or acetate pass the assumptions. The acetate is does not have sufficient homogeneity of variance, and not every supplement's data within the propionate section has a normal distribution.
