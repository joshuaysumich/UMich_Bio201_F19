...
CH4wk1_2x <- methane_long %>%
  filter(study_week == "week1", 
         supplement_consumed == "BRMPS", 
         frequency == "2xdaily") 
shapiro.test(CH4wk1_2x$ch4_mean) 
ggplot(CH4wk1_2x, aes(x = ch4_mean)) + geom_histogram()
...
ggplot(CH4wk3_2x, aes(x = ch4_mean)) + geom_histogram()

CH4wk1_1x <- methane_long %>%
  filter(study_week == "week1", 
         supplement_consumed == "BRMPS", 
         frequency == "1xdaily") 
shapiro.test(CH4wk1_1x$ch4_mean) 
ggplot(CH4wk1_1x, aes(x = ch4_mean)) + geom_histogram()
...
ggplot(CH4wk3_1x, aes(x = ch4_mean)) + geom_histogram()


var.test(x = CH4wk1_2x$ch4_mean, 
         y = CH4wk3_2x$ch4_mean, 
         alternative = "two.sided")

var.test(x = CH4wk1_1x$ch4_mean, 
         y = CH4wk3_1x$ch4_mean, 
         alternative = "two.sided")
...
acewk1_2x <- acetate_long %>%
  filter(study_week == "week1", 
         supplement_consumed == "BRMPS", 
         frequency == "2xdaily") 
shapiro.test(acewk1_2x$acetate_mean) 
ggplot(acewk1_2x, aes(x = acetate_mean)) + geom_histogram()
...
ggplot(acewk3_2x, aes(x = acetate_mean)) + geom_histogram()

acewk1_1x <- acetate_long %>%
  filter(study_week == "week1", 
         supplement_consumed == "BRMPS", 
         frequency == "1xdaily") 
shapiro.test(acewk1_1x$acetate_mean) 
ggplot(acewk1_1x, aes(x = acetate_mean)) + geom_histogram()
...
ggplot(acewk3_1x, aes(x = acetate_mean)) + geom_histogram()


var.test(x = acewk1_2x$acetate_mean, 
         y = acewk3_2x$acetate_mean, 
         alternative = "two.sided")

var.test(x = acewk1_1x$acetate_mean, 
         y = acewk3_1x$acetate_mean, 
         alternative = "two.sided")
...
prowk1_2x <- propionate_long %>%
  filter(study_week == "week1", 
         supplement_consumed == "BRMPS", 
         frequency == "2xdaily") 
shapiro.test(prowk1_2x$propionate_mean) 
ggplot(prowk1_2x, aes(x = propionate_mean)) + geom_histogram()

prowk3_2x <- propionate_long %>%
  filter(study_week == "week3", 
         supplement_consumed == "BRMPS", 
         frequency == "2xdaily") 
shapiro.test(prowk3_2x$propionate_mean) 
ggplot(prowk3_2x, aes(x = propionate_mean)) + geom_histogram()

prowk1_1x <- propionate_long %>%
  filter(study_week == "week1", 
         supplement_consumed == "BRMPS", 
         frequency == "1xdaily") 
shapiro.test(prowk1_1x$propionate_mean) 
ggplot(prowk1_1x, aes(x = propionate_mean)) + geom_histogram()

prowk3_1x <- propionate_long %>%
  filter(study_week == "week3", 
         supplement_consumed == "BRMPS", 
         frequency == "1xdaily") 
shapiro.test(prowk3_1x$propionate_mean) 
ggplot(prowk3_1x, aes(x = propionate_mean)) + geom_histogram()


var.test(x = prowk1_2x$propionate_mean, 
         y = prowk3_2x$propionate_mean, 
         alternative = "two.sided")

var.test(x = prowk1_1x$propionate_mean, 
         y = prowk3_1x$propionate_mean, 
         alternative = "two.sided")
...
pHwk1_2x <- pH_long %>%
  filter(study_week == "week1", 
         supplement_consumed == "BRMPS", 
         frequency == "2xdaily") 
shapiro.test(pHwk1_2x$ph_mean) 
ggplot(pHwk1_2x, aes(x = ph_mean)) + geom_histogram()
...
ggplot(pHwk3_2x, aes(x = ph_mean)) + geom_histogram()

pHwk1_1x <- pH_long %>%
  filter(study_week == "week1", 
         supplement_consumed == "BRMPS", 
         frequency == "1xdaily") 
shapiro.test(pHwk1_1x$ph_mean) 
ggplot(pHwk1_1x, aes(x = ph_mean)) + geom_histogram()
...
ggplot(pHwk3_1x, aes(x = ph_mean)) + geom_histogram()


var.test(x = pHwk1_2x$ph_mean, 
         y = pHwk3_2x$ph_mean, 
         alternative = "two.sided")

var.test(x = pHwk1_1x$ph_mean, 
         y = pHwk3_1x$ph_mean, 
         alternative = "two.sided")
